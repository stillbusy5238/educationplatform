...
class CourseInfoView(LoginRequiredMixin,View):
    ...
    def get(self,request,course_id):
        ...
        course.save()
        # 查询用户是否已经关联的该课程
        user_and_courses = UserCourse.objects.filter(user=request.user,course=course)
        if not user_and_courses:
        ...
        course_files = CourseResource.objects.filter(course=course)
